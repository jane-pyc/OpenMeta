...
class ViBEMetric(datasets.Metric):
    ...
    def _compute(self, predictions, references):
        ...
        precision_1 = precision_score(y_true = references, y_pred = predictions, average = 'weighted')
        recall_1 = recall_score(y_true = references, y_pred = predictions, average = 'weighted')
        f1_1 = f1_score(y_true = references, y_pred = predictions, average = 'weighted')
        ...
        return {
            ...
            "Macro recall": recall,
            "Weighted F1-score": f1_1,
            "Weighted precision": precision_1,
            "Weighted recall": recall_1,
        }
