...
def count_kmers(args_array):
    ...
    ret_ind, name_seq, ks, kmer_inds, vec_lens, shared_list = args_array
    
    name = name_seq[0]
    seq = name_seq[1]
    # print("starting count_kmers function... index: ",ret_ind)
    print("starting count_kmers function... name: ",name)
    ...
    # print("finishing counting all other kmers")
    ...
    kmer_freqs_tuple = (name, kmer_freqs)
    shared_list[ret_ind] = kmer_freqs_tuple
...
def count_kmers_biLSTM_att_w2v(args_array):
    ''' Count the k-mers in the sequence
        Return a dictionary of counts
        Assumes ks is sorted
    '''
    # print('count_kmers_biLSTM_att_w2v ...')
    ret_ind, names_w2v, shared_list = args_array
    
    name = names_w2v[0]
    w2v = names_w2v[1]

    kmer_freqs_tuple = (name, w2v)
    shared_list[ret_ind] = kmer_freqs_tuple